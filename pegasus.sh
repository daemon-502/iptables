...
# Autorise uniquement les connexions SSH venant de 10.92.160.100
iptables -t filter -A INPUT -p tcp --dport 22 -s 10.92.160.100 -j ACCEPT
iptables -t filter -A OUTPUT -p tcp --dport 22 -d 10.92.160.100 -j ACCEPT
echo "SSH autorisé uniquement pour Hydra"
...
echo "Mail autorisé"
# Autorise MariaDB (MySQL) en entrée et sortie pour l'adresse IP 10.92.160.10
iptables -t filter -A INPUT -p tcp --dport 3306 -s 10.92.160.10 -j ACCEPT
iptables -t filter -A OUTPUT -p tcp --dport 3306 -d 10.92.160.10 -j ACCEPT
echo "MariaDB autorisé uniquement pour Phoenix"
